const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_STEELIX}},
    ...
    [SPECIES_RHYDON]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_BLISSEY}},
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 32, SPECIES_SEADRA}},
    [SPECIES_SEADRA]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_TRADE_STONE, SPECIES_GLACEON}},
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_PORYGON2}},
    ...
    [SPECIES_PICHU]      = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_PIKACHU}},
    [SPECIES_TOGEPI]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_TOGETIC}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_LEVEL_ATK_LT_DEF, 20, SPECIES_HITMONCHAN},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_HITMONCHAN},
                            {EVO_LEVEL_ATK_GT_DEF, 20, SPECIES_HITMONLEE},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_HITMONLEE},
                            {EVO_LEVEL_ATK_EQ_DEF, 20, SPECIES_HITMONTOP},
                            {EVO_ITEM, ITEM_TRADE_STONE, SPECIES_HITMONTOP}},
    ...
    [SPECIES_NINCADA]    = {{EVO_LEVEL, 20, SPECIES_NINJASK}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_MILOTIC}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 42, SPECIES_GLALIE}, 
                            {EVO_ITEM, ITEM_TRADE_STONE, SPECIES_FROSLASS}},
    [SPECIES_AZURILL]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_MARILL}},
    ...
    [SPECIES_KIRLIA]     = {{EVO_LEVEL, 30, SPECIES_GARDEVOIR},
                            {EVO_ITEM, ITEM_TRADE_STONE, SPECIES_GALLADE}},
    [SPECIES_BAGON]      = {{EVO_LEVEL, 30, SPECIES_SHELGON}},
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 50, SPECIES_SALAMENCE}},
    [SPECIES_BELDUM]     = {{EVO_LEVEL, 20, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_LEVEL, 45, SPECIES_METAGROSS}},

    [SPECIES_BUDEW]      = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_ROSELIA}},
    [SPECIES_ROSELIA]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_ROSERADE}},
    [SPECIES_MIME_JR]    = {{EVO_LEVEL, 18, SPECIES_MR_MIME}},
    [SPECIES_AIPOM]      = {{EVO_LEVEL, 32, SPECIES_AMBIPOM}},
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_WEAVILE}},
    [SPECIES_GLIGAR]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_GLISCOR}},
    ...
    [SPECIES_MISDREAVUS] = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_MISMAGIUS}},
    [SPECIES_MURKROW]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_HONCHKROW}},
    [SPECIES_ELECTABUZZ] = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]     = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_MAGMORTAR}},
    [SPECIES_TOGETIC]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_TOGEKISS}},
    [SPECIES_HAPPINY]    = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_CHANSEY}},
    [SPECIES_MUNCHLAX]   = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_SNORLAX}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 33, SPECIES_LICKILICKY}},
    [SPECIES_MAGNETON]   = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE}},
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 34, SPECIES_MAMOSWINE}},
    [SPECIES_PORYGON2]   = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_PORYGON_Z}},
    [SPECIES_DUSCLOPS]   = {{EVO_ITEM, ITEM_TRADE_STONE, SPECIES_DUSKNOIR}},
};
