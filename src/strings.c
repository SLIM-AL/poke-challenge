...
const u8 gExpandedPlaceholder_Kyogre[] = _("PORYGON-Z");
const u8 gExpandedPlaceholder_Groudon[] = _("GALLADE");
const u8 gExpandedPlaceholder_Red[] = _("RED");
const u8 gExpandedPlaceholder_Green[] = _("GREEN");
const u8 gText_EggNickname[] = _("SMEARG EGG");
...
const u8 gText_AToZModeSeen[] = _("SEEN POKéMON");
const u8 gText_AToZModeAll[] = _("ALL POKéMON");
...
const u8 gText_PokemonListNoColor[] = _("POKéMON LIST (CLOCK IS RUNNING)");
...
const u8 gText_NextDataCancel[] = _("{A_BUTTON}POSSIBLE AREAS {B_BUTTON}CANCEL");
const u8 gText_Next[] = _("{A_BUTTON}NEXT");
const u8 gText_CancelPreviousData[] = _("{R_BUTTON}EXACT AREAS {A_BUTTON}CANCEL {B_BUTTON}BACK");
const u8 gText_PossibleArea[] = _("POSSIBLE AREAS");
const u8 gText_PreciseArea[] = _("0% AREAS");
const u8 gText_PreciseArea1[] = _("33% AREAS");
const u8 gText_PreciseArea2[] = _("67% AREAS");
const u8 gText_PreciseArea3[] = _("100% AREAS");
...
const u8 gSaveStatName_Time[] = _("TIME LEFT");
...
const u8 gText_MenuMobilePC[] = _("PC");
...
const u8 gText_LevelCap[] = _("CAP ");
const u8 gText_RequiredAtBadge[] = _("required at badge ");
const u8 gText_NoBadgeRequirement[] = _("no badge requirement");
...
const u8 gText_ChoosePokemon[] = _("(Level band is 7 levels wide.)");
...
const u8 gText_ChoosePokemon2[] = _("(Level band is 7 levels wide.)");
...
const u8 gText_Tm13_4000Coins[] = _("RANDOM TM 1{CLEAR_TO 0x48}{FONT_SMALL}150 COINS");
const u8 gText_Tm23_3500Coins[] = _("RANDOM TM 2{CLEAR_TO 0x48}{FONT_SMALL}150 COINS");
const u8 gText_Tm24_4000Coins[] = _("RANDOM TM 3{CLEAR_TO 0x48}{FONT_SMALL}150 COINS");
const u8 gText_Tm30_4500Coins[] = _("RANDOM TM 4{CLEAR_TO 0x48}{FONT_SMALL}150 COINS");
const u8 gText_Tm35_4000Coins[] = _("RANDOM TM 5{CLEAR_TO 0x48}{FONT_SMALL}150 COINS");
...
const u8 gText_Abra_180Coins[] = _("SURFIN' PIKACHU{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Clefairy_500Coins[] = _("ONLINE SMEARGLE{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Dratini_2800Coins[] = _("LEVEL 50 DITTO{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Scyther_5500Coins[] = _("LEVEL 20 LAPRAS{CLEAR_TO 0x5B}{FONT_SMALL} 300 COINS");
const u8 gText_Porygon_9999Coins[] = _("LEVEL 20 EEVEE{CLEAR_TO 0x5B}{FONT_SMALL} 500 COINS");

const u8 gText_Abra_120Coins[] = _("PICHU{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Clefairy_750Coins[] = _("MIME JR.{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Pinsir_2500Coins[] = _("IGGLYBUFF{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Dratini_4600Coins[] = _("AZURILL{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
const u8 gText_Porygon_6500Coins[] = _("TOGEPI{CLEAR_TO 0x5B}{FONT_SMALL} 150 COINS");
...
const u8 gText_MiracleSeed_1000Coins[] = _("SUNNY DAY{CLEAR_TO 0x50}{FONT_SMALL}100 COINS");
const u8 gText_Charcoal_1000Coins[] = _("RAIN DANCE{CLEAR_TO 0x50}{FONT_SMALL}100 COINS");
const u8 gText_MysticWater_1000Coins[] = _("SANDSTORM{CLEAR_TO 0x50}{FONT_SMALL}100 COINS");
const u8 gText_YellowFlute_1600Coins[] = _("TRICK ROOM{CLEAR_TO 0x50}{FONT_SMALL}100 COINS");
const u8 gText_SmokeBall_800Coins[] = _("HAIL{CLEAR_TO 0x50}{FONT_SMALL}100 COINS");
...
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("Replace this with a SMEARGLE that can\nlearn all TMs. Copy the EVs & IVs of a\nPOKéMON that's not on your final team.");
...
const u8 gText_TrainerCardSeed[] = _("Seed: ");
const u8 gText_TrainerCardGameHash[] = _("Game Hash: ");
const u8 gText_TrainerCardFineMapHash[] = _("F Map Hash: ");
const u8 gText_TrainerCardCoarseMapHash[] = _("C Map Hash: ");
...
const u8 gText_TrainerCardTime[] = _("Elapsed Time: ");
...
const u8 gText_Option[] = _("github.com/SLIM-AL/poke-challenge");
const u8 gText_TextSpeed[] = _("TEXT SPEED");
const u8 gText_BattleScene[] = _("BATTLE SCENE");
const u8 gText_BattleStyle[] = _("BATTLE STYLE");
const u8 gText_Sound[] = _("NEXT BADGE LVL CAP");
const u8 gText_ButtonMode[] = _("EXP GAIN MESSAGE");
...
const u8 gText_SoundMono[] = _("WARNING ON");
const u8 gText_SoundStereo[] = _("WARNING OFF");
const u8 gTextJP_Type[] = _("タイプ");
const u8 gText_ButtonTypeHelp[] = _("ON");
const u8 gText_ButtonTypeLEqualsA[] = _("OFF");
...
const u8 gText_PlayerScurriedToCenter[] = _("You scurried away, protecting the\nfainted POKéMON from further harm‥\p");
const u8 gText_PlayerScurriedBackHome[] = _("You scurried away, protecting the\nfainted POKéMON from further harm‥\p");
...
const u8 gString_OutOfCoins[] = _("You have been awarded\n50 pity COINS!");
...
const u8 gText_MonIsTryingToLearnMove[] = _("{STR_VAR_1} is trying to learn\n{STR_VAR_2}.\pBut the move limit is four.\nDelete an older one to make room?");
