...
const u8 gMoveDescription_Brine[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Fling[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_ChargeBeam[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_DragonPulse[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_DrainPunch[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Embargo[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_ShadowClaw[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Payback[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_GigaImpact[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_RockPolish[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_StoneEdge[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Avalanche[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_GyroBall[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_StealthRock[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Captivate[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_DarkPulse[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_XScissor[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_NaturalGift[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_PoisonJab[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_GrassKnot[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
const u8 gMoveDescription_Pluck[] = _("This is a Gen IV\nmove. It might not\nwork in this hack,\nbut will online!");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    // Gen IV moves:
    [MOVE_AIR_SLASH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_AQUA_JET - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_AQUA_RING - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_AQUA_TAIL - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ASSURANCE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ATTACK_ORDER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_AURA_SPHERE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_AVALANCHE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_BRAVE_BIRD - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_BRINE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_BUG_BITE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_BUG_BUZZ - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_BULLET_PUNCH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CAPTIVATE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CHARGE_BEAM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CHATTER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CLOSE_COMBAT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_COPYCAT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CROSS_POISON - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_CRUSH_GRIP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DARK_PULSE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DARK_VOID - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DEFEND_ORDER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DEFOG - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DISCHARGE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DOUBLE_HIT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DRACO_METEOR - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DRAGON_PULSE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DRAGON_RUSH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_DRAIN_PUNCH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_EARTH_POWER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_EMBARGO - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ENERGY_BALL - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FEINT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FIRE_FANG - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FLARE_BLITZ - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FLASH_CANNON - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FLING - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FOCUS_BLAST - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_FORCE_PALM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GASTRO_ACID - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GIGA_IMPACT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GRASS_KNOT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GRAVITY - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GUARD_SWAP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GUNK_SHOT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_GYRO_BALL - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HAMMER_ARM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HEAD_SMASH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HEAL_BLOCK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HEAL_ORDER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HEALING_WISH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_HEART_SWAP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ICE_FANG - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ICE_SHARD - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_IRON_HEAD - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_JUDGMENT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_LAST_RESORT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_LAVA_PLUME - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_LEAF_STORM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_LUCKY_CHANT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_LUNAR_DANCE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MAGMA_STORM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MAGNET_BOMB - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MAGNET_RISE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ME_FIRST - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_METAL_BURST - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MIRACLE_EYE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MIRROR_SHOT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_MUD_BOMB - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_NASTY_PLOT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_NATURAL_GIFT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_NIGHT_SLASH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_OMINOUS_WIND - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_PAYBACK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_PLUCK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_POISON_JAB - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_POWER_GEM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_POWER_SWAP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_POWER_TRICK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_POWER_WHIP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_PSYCHO_CUT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_PSYCHO_SHIFT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_PUNISHMENT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ROAR_OF_TIME - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ROCK_CLIMB - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ROCK_POLISH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ROCK_WRECKER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ROOST - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SEED_BOMB - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SEED_FLARE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SHADOW_CLAW - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SHADOW_FORCE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SHADOW_SNEAK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SPACIAL_REND - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_STEALTH_ROCK - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_STONE_EDGE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SUCKER_PUNCH - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_SWITCHEROO - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_TAILWIND - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_THUNDER_FANG - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_TOXIC_SPIKES - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_TRICK_ROOM - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_TRUMP_CARD - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_U_TURN - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_VACUUM_WAVE - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_WAKE_UP_SLAP - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_WOOD_HAMMER - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_WORRY_SEED - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_WRING_OUT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_X_SCISSOR - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ZEN_HEADBUTT - 1] = gMoveDescription_Gen4Placeholder,
    [MOVE_ACUPRESSURE - 1] = gMoveDescription_Gen4Placeholder
};
