...
{
    if (gBattleTypeFlags & BATTLE_TYPE_PORYGON_Z_GALLADE)
        return MUS_VS_WILD;
...
bool8 ShouldIgnoreDeoxysForm(u8 caseId, u8 battlerId)
{
    ...
    default:
        return FALSE;
    case GLACEON_CHECK_BATTLE_SPRITE:
    ...
    case 4:
        break;
    case GLACEON_CHECK_BATTLE_ANIM:
        if (gBattleTypeFlags & BATTLE_TYPE_LINK)
        {
            if (!gMain.inBattle)
                return FALSE;
...
void HandleSetPokedexFlag(u16 nationalNum, u8 caseId, u32 personality)
{
    ...
    if (!GetSetPokedexFlag(nationalNum, getFlagCaseId))
    {
        ...
        if (NationalPokedexNumToSpecies(nationalNum) == SPECIES_UNOWN_B)
