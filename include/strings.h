...
extern const u8 gText_MenuMobilePC[];
...
extern const u8 gText_AToZModeSeen[];
extern const u8 gText_AToZModeAll[];
...
extern const u8 gText_PossibleArea[];
extern const u8 gText_PreciseArea[];
extern const u8 gText_PreciseArea1[];
extern const u8 gText_PreciseArea2[];
extern const u8 gText_PreciseArea3[];
...
extern const u8 gText_TrainerCardFineMapHash[];
extern const u8 gText_TrainerCardCoarseMapHash[];
